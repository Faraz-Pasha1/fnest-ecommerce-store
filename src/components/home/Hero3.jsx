...
const Hero3 = () => {
  const slides = [
    {
      type: 'image',
      url: '/3-meetha-pan-masala-mukhwas-mouth-freshener-fnest-tradition-refreshness.webp',
      mobileUrl: '/3-meetha-pan-masala-mukhwas-mouth-freshener-fnest-tradition-refreshness-portrait.webp',
      buttonText: 'SHOP NOW',
    },
  ];
